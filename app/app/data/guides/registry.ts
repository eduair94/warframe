...
export const GUIDES_INDEX: GuideMeta[] = [
  ...
  { slug: 'forma', route: '/guides/forma', title: 'Forma Farming', blurb: 'Choose the right relic refinement, compare built Forma sources and check the Plague Star 2026 rewards.', category: 'farming', icon: 'mdi-vector-triangle', readMins: 9 },
