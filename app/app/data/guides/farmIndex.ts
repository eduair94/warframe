...
export const FARM_TARGETS: FarmTarget[] = [
  ...
  { name: 'Endo', aliases: ['ayatan', 'ayatan sculpture', 'ayatan star', 'mod upgrade currency'], kind: 'currency', guide: 'endo', route: '/guides/endo', hint: 'Ayatan sculptures, Arbitrations and endo-dense missions.', icon: 'mdi-hexagon-multiple-outline' },
