...
export const FARM_TARGETS: FarmTarget[] = [
  ...
  { name: 'Forma', aliases: ['forma blueprint', 'forma bundle', 'aura forma', 'umbra forma', 'stance forma', 'omni forma', 'polarize', 'polarity'], kind: 'gear', guide: 'forma', route: '/guides/forma', hint: 'A common Void Relic reward — run relics Intact in a full squad, or use the non-relic sources.', icon: 'mdi-vector-triangle' },
  { name: 'Forma relics', aliases: ['which relics drop forma', 'forma relic', 'relics with forma', 'forma drop relics'], kind: 'gear', guide: 'forma', route: '/forma-relics', hint: 'Every relic that drops a Forma Blueprint — currently dropping by default, with the exact drop nodes and a star-map view.', icon: 'mdi-vector-triangle' },
